    ...
    <div className="navbar bg-base-100 shadow-md">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            ...
            {isAdmin && <li><Link to="/admin" className="text-primary">Admin Dashboard</Link></li>}
          </ul>
        </div>
        <Link to="/" className="btn btn-ghost text-xl">GigleGig's Blog</Link>
      </div>
      ...
      <div className="navbar-end">
        <div className="flex gap-2">
          <a href="https://github.com/GigleGig" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle">
          ...
          <a href="https://x.com/hexaburden" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle">
          ...
          <a href="https://www.linkedin.com/in/xiaofeng-zhang-61a16b261/" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle">
